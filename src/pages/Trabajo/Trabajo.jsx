...
<div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center items-center">
  ...
  >
    Volver al inicio
      ...
      <h1 className="text-3xl font-semibold mb-2">Trabajo — Próximamente…</h1>
      <p className="text-gray-600 max-w-prose">
        Estamos preparando la{" "}
        <span className="font-medium">Bolsa de Trabajo</span> para pueblos de
        México. Muy pronto podrás explorar oportunidades locales, remotas y
